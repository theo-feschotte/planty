...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="entry-content">
        ...
        <section class="c-texts" <?php echo( $texts_background_color ? 'style="background-color:'.$texts_background_color.';"' : '' ); ?> >
            <div class="o-wrapper-sm">
                <?php echo( $texts ); ?>
            </div>
        </section>
        
        <section class="c-flavours" <?php echo( $flavours_background_color ? 'style="background-color:'.$flavours_background_color.';"' : '' ); ?> >
        ...
        <section class="c-testimonials" <?php echo( $testimonials_background_color ? 'style="background-color:'.$testimonials_background_color.';"' : '' ); ?> >
            <div class="o-wrapper-xl">
                        ...
                        echo( '<li class="c-testimonials__list-item">' );
                            echo( '
                                <div class="c-testimonials__list-image" style="animation-delay:calc(0.5s + '.$delay.'s)">
                                    ...
                                    <img style="clip-path:url(#p-shape-'.$key.')" src="'.$testimonial["image"]["url"].'" alt="'.$testimonial["image"]["alt"].'"/>
                                </div>
                            ' );
